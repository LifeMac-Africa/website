...
<footer>
    <div class="footer-area">
        <div class="footer-top footer-bg" style="padding: 30px 0;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-widget wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                            <h4 class="fw-title mb-20">News Feeds<span>.</span></h4>
        ...
        <div class="footer-bottom" style="padding: 15px 0; color: white;">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <div class="copyright-text">
                    <p>
                        <span id="currentYear"></span> Copyright, Lifemac-Africa. All rights reserved.
                    </p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="footer-bottom-right">
                    <ul style="list-style-type: none; padding-left: 0;">
                        <li class="mr-10"><a href="#">Privacy Charity Policy</a></li>
