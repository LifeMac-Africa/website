...
?>
    ...
    <div class="slider-active">
        <div class="single-slider slider-bg" data-background="images/seth-doyle-zf9_yiAekJs-unsplash.jpg" style="background-image: url('images/seth-doyle-zf9_yiAekJs-unsplash.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-12">
