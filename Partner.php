                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div class="section-title text-center mb-50">
                                <div class="overlay-title">Life-Mac</div>
                                <span class="sub-title">-- Sponsors --</span>
                                <h2 class="title">Life-Mac Africa Sponsors</h2>
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/un.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/YLT.png" alt=""></a>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/1500x500.jpeg" alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/gesi-logo.jpg" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/CN-Charity-and-PR-blog.jpg" alt=""></a>
                            </div>
                        </div>
                     
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="brand-item">
                                <a href="#"><img src="./images/ngo.jpg" alt=""></a>
                            </div>
                        </div>
