...
<section class="slider-area">
    <div class="slider-active">
        <div class="single-slider slider-bg" data-background="images/bg_2.jpg" style="background-image: url('images/bg_2.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-12">
...
<div class="featured-section overlay" style="background-image: url('images/bg_1.jpg');">
    <!-- Content -->
    <div class="container">
        <div class="row">
