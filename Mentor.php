...
<section id="impact-stories" class="section">
    ...
    <div class="container">
        ...
        <div class="card-grid">
            ...
            <!-- Card 1 -->
            <div class="card">
            <img src="./images/Director of Communications.jpeg" alt="Story 1 Image" class="card-img">
            ...
            <!-- Card 2 -->
            <div class="card">
            <img src="./images/Founder & Executive Director.jpeg" alt="Story 2 Image" class="card-img">
                <div class="card-overlay">
                    <h3 class="card-title">Education Initiatives</h3>
            ...
            <img src="images/chitto-cancio-jZ3UUjdMA6M-unsplash.jpg" alt="Story 3 Image" class="card-img">
                <div class="card-overlay">
                    <h3 class="card-title">Clean Energy Projects</h3>
